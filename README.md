...
- kebbott-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- kebbott-ui: main application module, development time
- kebbott-production: module that produces a production mode WAR for deployment
